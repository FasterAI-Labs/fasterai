"""Docs: https://FasterAI-Labs.github.io/fasterai/core/criteria.html.md"""
...
class Criteria():
    def __init__(self, 
                 ...
                 return_init=False,
                 scale: dict[nn.Module, torch.Tensor] | None = None,
    ...
    def calibrate(self,
                  ...
                  layer_type: type[nn.Module] = nn.Conv2d,  # Layer types to hook
                  n_batches: int = 5,
    ) -> None:
