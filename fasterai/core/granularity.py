...
# %% ../../nbs/core/granularity.ipynb #hungarian-american
...
# %% ../../nbs/core/granularity.ipynb #9602698b-b5e6-4087-83ee-370cb62616e0
class Granularities:
    ...
    _granularities: dict[Type[nn.Module], dict[str, int | tuple]] = {
    ...
    def get_dim(cls, 
        m: nn.Module,
        g: str        # Granularity name, e.g. 'weight' or 'filter'
    ) -> int | list[int]:
